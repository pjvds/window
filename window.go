...
// SliceCopy will do exactly the same as
// Slice, but will return a copy instead
// of slice pointing to the array.
func (m *MovingWindow) SliceCopy() []float64 {
	slice := make([]float64, 0, m.size)
	copy(slice, m.Slice())
